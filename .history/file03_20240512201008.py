class Employee:
    ...
    def write_employees(self, filename: str) -> None: # Writes the employee's information along with years worked and total salary expense to a text file specified by the filename parameter.
        """
